...
describe('utils', () => {
  ...
  describe('searchNotes', () => {
    const notes: Note[] = [
      createMockNote({ id: '1', title: 'React 학습', content: '컴포넌트 기초' }),
      createMockNote({ id: '2', title: 'TypeScript', content: '타입 시스템', tags: ['타입스크립트'] }),
      createMockNote({ id: '3', title: '할일 목록', content: 'React 프로젝트' }),
    ];
  ...
  describe('sortNotes', () => {
    const notes: Note[] = [
      createMockNote({ id: '1', title: '가나다', createdAt: '2025-01-20T10:00:00Z', updatedAt: '2025-01-21T10:00:00Z' }),
      createMockNote({ id: '2', title: '라마바', createdAt: '2025-01-19T10:00:00Z', updatedAt: '2025-01-22T10:00:00Z' }),
      createMockNote({ id: '3', title: '아자차', createdAt: '2025-01-21T10:00:00Z', updatedAt: '2025-01-20T10:00:00Z' }),
    ];
