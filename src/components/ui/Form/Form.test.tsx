...
describe('FormActions', () => {
  ...
  it('align="center"로 가운데 정렬할 수 있다', () => {
    ...
    expect((container.firstChild as HTMLElement)?.className).toMatch(/formActionsCenter/);
  });
  ...
  it('align="end"로 오른쪽 정렬할 수 있다', () => {
    ...
    expect((container.firstChild as HTMLElement)?.className).toMatch(/formActionsEnd/);
  });
