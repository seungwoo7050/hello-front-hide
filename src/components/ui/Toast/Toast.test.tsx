...
describe('Toast', () => {
  ...
  it('타이틀이 있으면 표시한다', () => {
    render(
      <Toast id="test-2" message="메시지" title="제목" onClose={() => {}} />
    )
  ...
  it('success 타입 토스트를 렌더링한다', () => {
    render(
      <Toast id="test-3" message="성공!" type="success" onClose={() => {}} />
    )
  ...
  it('error 타입 토스트를 렌더링한다', () => {
    render(
      <Toast id="test-4" message="오류!" type="error" onClose={() => {}} />
    )
  ...
  it('warning 타입 토스트를 렌더링한다', () => {
    render(
      <Toast id="test-5" message="경고!" type="warning" onClose={() => {}} />
    )
  ...
  it('closable이 false면 닫기 버튼이 없다', () => {
    render(
      <Toast id="test-8" message="메시지" onClose={() => {}} closable={false} />
    )
  ...
  it('duration 후에 자동으로 닫힌다', async () => {
    ...
    render(
      <Toast id="test-9" message="메시지" duration={3000} onClose={onClose} />
    )
  ...
  it('duration이 0이면 자동으로 닫히지 않는다', async () => {
    ...
    render(
      <Toast id="test-10" message="메시지" duration={0} onClose={onClose} />
    )
